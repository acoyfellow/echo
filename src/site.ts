  ...
  const html =
    ...
    <section class="hero">
      ...
      <p class="lead" style="font-size: 17px;">
        ...
        With no extension attached, the call returns <code>session_unbound</code> &mdash; the supervisor refusing to deliver code to a tab that isn't there. For a useful run you need the extension and a tab.
      </p>
    </section>
